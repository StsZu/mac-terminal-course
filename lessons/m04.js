  ...
  lessons: [
    {
      ...
      steps: [
        ...
        { type: "terminal", title: "Спробуй: ping роутера",
          ...
          expected: ["ping -c 3 10.0.0.254", "ping 10.0.0.254 -c 3", "ping -c3 10.0.0.254", "ping 10.0.0.254 -c3"],
    ...
    },
    {
      ...
      steps: [
        ...
        { type: "terminal", title: "Спробуй: хто на порту 3000",
          ...
          expected: ["lsof -i :3000", "lsof -i:3000", "lsof -nP -i :3000", "lsof -iTCP:3000", "lsof -i tcp:3000", "lsof -P -i :3000", "lsof -nP -i:3000"],
